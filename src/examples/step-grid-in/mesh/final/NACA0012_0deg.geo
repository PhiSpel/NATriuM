...
//top
Transfinite Curve {232} = n_sponge_front Using Progression progression_sponge_front;  // sponge front/diagonal lines
Transfinite Curve {230} = n_sponge_back Using Progression progression_sponge_back;  // sponge back lines
//bottom
Transfinite Curve {233} = n_sponge_front Using Progression progression_sponge_front;  // sponge front/diagonal lines
Transfinite Curve {231} = n_sponge_back Using Progression progression_sponge_back;  // sponge back lines
