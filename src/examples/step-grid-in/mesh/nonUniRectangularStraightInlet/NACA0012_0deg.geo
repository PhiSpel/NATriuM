...
Transfinite Curve {-203, -204, -201, -202} = n_around Using Progression progression_around;  // inlet lines points
Transfinite Curve {205, 206} = n_inlet_tb Using Progression progression_around;        // inlet circle points
