...
>>>>>>> e420fa3173d619c4c9997485a43a7a3a738632c7
point_id_top = 64;
point_id_front = 100;
point_id_bot = 136;
n_around     = 70;
...
channel_l    = 1.5;
channel_h    = inlet_r;
n_channel    = 80;  // number of points on top and bottom
n_outlet_center = 1300;
...
/// INLET
Point(2200) = {0, inlet_r, 0, size_in};       // inlet top
Point(2201) = {0, -inlet_r, 0, size_in};      // inlet bottom
Point(2202) = {inlet_c-inlet_front, 0, 0, size_in};     // inlet front
Point(2203) = {inlet_c, 0, 0};                    // inlet center
//Line(2200)  = {point_id_front, 2202};             // inlet front line
//Line(2201)  = {2200, point_id_top};               // inlet top line
//Line(2202)  = {2201, point_id_bot};               // inlet bottom line
Ellipse(2203) = {2200, 2203, 2203, 2202};         // inlet circle line top
Ellipse(2204) = {2202, 2203, 2203, 2201};         // inlet circle line bottom
//Curve Loop (2200) = {-2203, 2201, point_id_top:point_id_front-1, 2200}; // inlet loop top
//Curve Loop (2201) = {-2200, point_id_front:point_id_bot-1, -2202, -2204}; // inlet loop bottom
//Plane Surface(1) = {2200};                        // inlet surface top
//Plane Surface(2) = {2201};                        // inlet surface bottom

/// OUTLET
Point(2210) = {outlet_c, outlet_h, 0, size_out};   // outlet top
Point(2211) = {outlet_c, -outlet_h, 0, size_out};  // outlet bottom
Point(2212) = {outlet_c, 0, 0, size_out};          // outlet center
//Line(2210)  = {1, 2212};                              // outlet center line
Line(2211)  = {2210, 2212};                           // outlet end top line
Line(2212)  = {2211, 2212};                           // outlet end bottom line

/// CHANNEL
//Line(2220)  = {2200, 2210};                           // channel top line
//Line(2221)  = {2201, 2211};                           // channel bottom line

/// OUTLET / CHANNEL SURFACES
//Curve Loop(2222) = {-2201, 2220, 2211, -2210, 1:point_id_top-1}; // channel top
//Curve Loop(2223) = {2202, point_id_bot:nx, 2210, -2212, -2221}; // channel bottom
//Plane Surface(5) = {2222};                            // channel top
//Plane Surface(6) = {2223};                            // channel bottom

/// SPONGE
Point(2230) = {outlet_c, sponge_h, 0, size_sponge};   // sponge top back
Point(2231) = {outlet_c, -sponge_h, 0, size_sponge};  // sponge bottom back
Line(2230)  = {2210, 2230};                           // sponge outlet top line
Line(2231)  = {2211, 2231};                           // sponge outlet bottom line
Line(2232)  = {2200, 2230};                           // sponge top line
Line(2233)  = {2201, 2231};                           // sponge bottom line
//Curve Loop(2230) = {2232, -2230, -2220};              // sponge surface top
//Curve Loop(2231) = {2221, 2231, -2233};               // sponge surface top
//Plane Surface(7) = {2230};                            // sponge top
//Plane Surface(8) = {2231};                            // sponge bottom

/// INNER SURFACE
//Curve Loop (2240) = {-2204,-2203,2220,2211,-2212,-2221};
Curve Loop (2240) = {-2204,-2203,2232,-2230,2211,-2212,2231,-2233};
Curve Loop (2241) = {1:nx};
Plane Surface(9) = {2240,2241};
//Plane Surface(10) = {2241};
...
//Recombine Surface{1,2,5,6,7,8,9,10};
Recombine Surface{9};

/// BOUNDARIES
Physical Curve(300) = {2233, 2204, 2203, 2232};  // "Inlet", 
Physical Curve(302) = {2231, 2212, 2211, 2230};  // "Outlet", 
Physical Curve(303) = {1:nx};  // "BB_BC", 
//Physical Surface(236) = {1, 2, 6, 5, 7, 8, 9, 10};
Physical Surface(236) = {9};
