 ...
 *          @snippet lidDrivenCavity2D.cpp Includes
 *
 *    We include the namespace natrium to access all classes and functions directly.
 *    		@snippet lidDrivenCavity2D.cpp Namespace
 *
 ...
 *    		@snippet lidDrivenCavity2D.cpp Main function
 *
 ...
 *    		@snippet lidDrivenCavity2D.cpp Discretization
 *
 ...
 *    		@snippet lidDrivenCavity2D.cpp Definition
 *
 ...
 *    		@snippet lidDrivenCavity2D.cpp Configuration
 *
 ...
 *    		@snippet lidDrivenCavity2D.cpp Problem
 *
 *	  Finally, we are ready to create the CFD solver and run the simulation.
 *    		@snippet lidDrivenCavity2D.cpp Solver
 *
 *
 *
 * @date 31.03.2014
